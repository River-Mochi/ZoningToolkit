...
if (!CSII_USERDATAPATH) {
    throw new Error(
        "CSII_USERDATAPATH environment variable is not set, ensure the CSII Modding Toolchain is installed correctly"
    );
}
...

            {
                ...
                use: [
                    ...
                    },
                    {
                        loader: "sass-loader",
                        options: {
                            // Force the modern Dart Sass API (removes the “legacy JS API” deprecation warnings)
                            api: "modern",
